...
class SShimmerSkeleton extends StatelessWidget {
  ...
  ///
  /// Defaults to the secondary color of the theme.
  ...
  /// The number of animation loop, set value of `0` to make animation run forever.
  ///
  /// Defaults to 0.
  final int loop;

  /// Whether the shimmer effect should be enabled.
  ///
  /// Defaults to true.
  final bool enabled;
